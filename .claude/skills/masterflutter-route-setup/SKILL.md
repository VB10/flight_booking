---
name: masterflutter-route-setup
description: >-
  ...
  MaterialApp.router. Use when user runs /masterflutter-route-setup or asks to add
...
- User invokes **`/masterflutter-route-setup`** or asks to set up navigation/routing for the project.
...
- **`/masterflutter-route-setup`** — or just describe the task; the
